    ...
    <div className="flex gap-4 mb-4 justify-between">
      <div className="space-y-6">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className='flex items-center gap-2 text-sm text-muted-foreground'>
            <Clock className="h-4 w-4 text-rose-400" /> {readingTime} min read {' '}
          </div>
        </div>
        <h1 className="text-2x1 lg:text-4x1 font-bold lg:tracking-tight">
      ...
      <div className='self-start'>
        <Link href="/dashboard">
          <Button
            ...
            shadow-xs hover:shadow-md hover:border-rose-100%
            30 !bg-rose-100 px-2 sm:px-3"
          >
            <ChevronLeft
